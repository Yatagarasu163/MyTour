...
export default function PostReportButton(props){
    ...
    async function onFormSubmit(event){
        ...
        const res = await fetch("/api/admin/posts/report", {
            method: "POST",
        ...
        if(res.status === 409){
            setSubmitMessage("This post has already been reported by you!");
